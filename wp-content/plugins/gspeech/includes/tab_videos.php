			...
			<div class="gsp_gspeech_info_inner_c">
				...
				<ul class="gsp_info_ul">
					...
					<li class="gsp_link_list_20">
						...
						<span class="gsp_info_sep" data-att="inj"></span>
						<span class="gsp_link_info gsp_link_info_plg_v"><?php echo GSPEECH_PLG_VERSION; ?></span>
					</li>
				</ul>
				...
				<ul class="gsp_info_intro_links_ul">
					...
					<li class="gsp_link_info_docs">
						<a href="https://gspeech.io/text-to-speech-wordpress-tts-plugin" target="_blank">
							<span class="gsp_link_icon"></span>
			...
			<div class="gsp_gspeech_info_inner_c">
				...
				<ul class="gsp_info_ul">
					...
					<li class="gsp_link_list_20 title_holder_vertical">
						<span class="gsp_list_link_style">
							<span class="gsp_link_icon"></span>
							<span class="gsp_link_content">GTranslate Plugin Support</span>
						</span>
						<span class="gsp_info_sep"></span>
						<span class="gsp_link_info">Nice Combination of <b>GTranslate and GSpeech</b>!</span>
						<span class="questions_icon"><img src="<?php echo plugin_dir_url( __FILE__ ); ?>/images/svg/info.svg" /></span>
						<span class="gs_title_vertical"><span class="title_v_subtitle">GTranslate Plugin Support:</span> Fully compatibility with GTranslate plugin.<br /><br />You can use all the beautiful views of GTranslate Language Switcher in combination with GSpeech power!</span>
					</li>
					<li class="gsp_link_list_20 title_holder_vertical">
						<span class="gsp_list_link_style">
							<span class="gsp_link_icon"></span>
				...
				<a href="https://gspeech.io/#pricing" target="_blank" class="gsp_upg_link gsp_activate_upgrade" style="width: 350px;margin-top: 20px;">Upgrade to unlock <img src="<?php echo plugin_dir_url( __FILE__ ); ?>/images/svg/lock.svg" /></a>
			</div>
		</div>
			...
			<div class="gsp_gspeech_info_inner_c">
				...
				<ul class="gsp_info_ul">
					...
					<li class="gsp_link_list_3">
						<a href="https://gspeech.io/text-to-speech-wordpress-tts-plugin" target="_blank">
							<span class="gsp_link_icon"></span>
							<span class="gsp_link_content">Implementation Guide (video demos)</span>
						</a>
						<span class="gsp_info_sep"></span>
